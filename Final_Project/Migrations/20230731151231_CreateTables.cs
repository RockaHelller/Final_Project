        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ResolutionP = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SoftDelete = table.Column<bool>(type: "bit", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Films_Resolutions_ResolutionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DatePlan = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MultiplyWatching = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Pricings_Resolutions_ResolutionId",
                        column: x => x.ResolutionId,
                        principalTable: "Resolutions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Pricings_VideoQualities_VideoQualityId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FilmTopics", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FilmTopics_Films_FilmId",
                        column: x => x.FilmId,
                        principalTable: "Films",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FilmTopics_Topics_TopicId",
                        column: x => x.TopicId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Films_ResolutionId",
                table: "Films",
                column: "ResolutionId");

            migrationBuilder.CreateIndex(
                name: "IX_FilmTopics_FilmId",
                table: "FilmTopics",
                column: "FilmId");

            migrationBuilder.CreateIndex(
                name: "IX_FilmTopics_TopicId",
                table: "FilmTopics",
                column: "TopicId");

            migrationBuilder.CreateIndex(
                name: "IX_Pricings_ResolutionId",
                table: "Pricings",
                column: "ResolutionId");

            migrationBuilder.CreateIndex(
                name: "IX_Pricings_VideoQualityId",
                table: "Pricings",
